...
__attributes = {
    ...
    'SparseStructureFlowMultiBranchModel': 'sparse_structure_flow_multi_branch',
}
...
if __name__ == '__main__':
    ...
    from .sparse_structure_flow_multi_branch import SparseStructureFlowMultiBranchModel